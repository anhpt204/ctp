...
#             os.path.join(data_dir, 'A2-20-100-100-4.ctp'),
             os.path.join(data_dir, 'A2-20-100-100-8-500.ctp'),
...
#         tours = [[13, 47, 36, 52]]
        tours = [[15,43,83,10,44,35,9,18],[5,71,4,42,85,94,1,64],[52],[3,13,56,2,88,29,67,26],[31,6,77, 8,36,17,48,11],[19,41,24,16,7,21,12,14]]
